...
def _valuespec_special_agents_sqlquery():
    return Dictionary(
        title = _("sqlquery"),
        ...
        elements = [
            ...
            ("-i", TextAreaUnicode(title = _("Query"), size=60, rows=20, cols=50, allow_empty = False, help = _("Type or paste your query with 'quotes' here. Make sure yor query outputs service name first and second the value"))),
        ],
        optional_keys=[],
    )
...
rulespec_registry.register(
    HostRulespec(
        ...
        name="special_agents:sqlquery",
        valuespec=_valuespec_special_agents_sqlquery,
    )
)
